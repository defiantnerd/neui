...
namespace neui_detail
{
  ...
  inline constexpr WellKnownAttr k_well_known_attrs[] = {
    ...
    { NEUI_ATTR_CONTENT_HEIGHT,       AttrKind::INT    },
    ...
    { NEUI_ATTR_QRCODE,               AttrKind::STRING },
    { NEUI_ATTR_COMBO_MAX_VISIBLE,    AttrKind::INT    },
    { NEUI_ATTR_COMBO_DROP_WIDTH,     AttrKind::INT    },
    { NEUI_ATTR_KNOB_MODE,            AttrKind::INT    },
    { NEUI_ATTR_TAB_POSITION,         AttrKind::STRING },
    { NEUI_ATTR_TAB_STRIP_SIZE,       AttrKind::INT    },
    { NEUI_ATTR_TAB_BORDER_COLOR,     AttrKind::INT    },
    { NEUI_ATTR_TAB_BORDER_WIDTH,     AttrKind::INT    },
    { NEUI_ATTR_TAB_CHIP_BG_COLOR,    AttrKind::INT    },
    { NEUI_ATTR_TAB_CHIP_TEXT_COLOR,  AttrKind::INT    },
    { NEUI_ATTR_TAB_CHIP_RADIUS,      AttrKind::INT    },
    { NEUI_ATTR_TAB_STRIP_BG_COLOR,   AttrKind::INT    },
    { NEUI_ATTR_NAV_COUNT,            AttrKind::INT    },
    { NEUI_ATTR_NAV_INDEX,            AttrKind::INT    },
    { NEUI_ATTR_NAV_PAGE,             AttrKind::INT    },
    { NEUI_ATTR_NAV_WRAP,             AttrKind::INT    },
