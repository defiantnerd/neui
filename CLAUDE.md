...
- **Per-child-widget DnD on macOS native** - `NEUINativeContentView` dispatches; per-painted-view `<NSDraggingDestination>` opt-in is deferred. (Win32 native + xpl already walk the widget tree.)
